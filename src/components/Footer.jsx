...
const Footer = () => {
  return (
    <footer className="footer-container">
      ...
      {/* LIENS AU CENTRE - Navigation sémantique */}
      <nav className="footer-links-wrapper" aria-label="Liens secondaires">
      ...
      <div className="footer-socials">
        <a
          ...
          aria-label="Suivez-nous sur Facebook (ouvre un nouvel onglet)"
        >
          <svg
            width="24"
            height="24"
        ...
        <a
          ...
          rel="noopener noreferrer"
          className="footer-social-icon"
          aria-label="Suivez-nous sur Instagram (ouvre un nouvel onglet)"
        >
          <svg
            width="24"
            height="24"
        ...
        <a
          ...
          rel="noopener noreferrer"
          className="footer-social-icon"
          aria-label="Suivez-nous sur X (Twitter) (ouvre un nouvel onglet)"
        >
          <svg
            width="22"
            height="22"
